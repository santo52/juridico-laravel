...
use App\Entities\ProcesoEtapaActuacionBitacora;
use App\Entities\ProcesoEtapaBitacora;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        ProcesoBitacora::observe(BaseObserver::class);
        ProcesoEtapa::observe(BaseObserver::class);
        ProcesoEtapaActuacion::observe(BaseObserver::class);
        ProcesoEtapaActuacionBitacora::observe(BaseObserver::class);
        ProcesoEtapaBitacora::observe(BaseObserver::class);
