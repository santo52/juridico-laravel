...
var EstadoCuentaReporte = /*#__PURE__*/function () {
  function EstadoCuentaReporte() {
    _classCallCheck(this, EstadoCuentaReporte);
  }

  _createClass(EstadoCuentaReporte, [{
    key: "generatePDF",
  ...
  return EstadoCuentaReporte;
}();

var estadoCuentaReporte = new EstadoCuentaReporte();

var GestionOrganizacionalReporte = /*#__PURE__*/function () {
  function GestionOrganizacionalReporte() {
    _classCallCheck(this, GestionOrganizacionalReporte);
  }

  _createClass(GestionOrganizacionalReporte, [{
    key: "generatePDF",
    value: function generatePDF(e) {
      if (validateForm(e)) {
        var formData = new FormData(e.target);
  ...
  return GestionOrganizacionalReporte;
}();

var gestionOrganizacionalReporte = new GestionOrganizacionalReporte();
...
var HonorariosReportes = /*#__PURE__*/function () {
  function HonorariosReportes() {
    _classCallCheck(this, HonorariosReportes);
  }

  _createClass(HonorariosReportes, [{
    key: "generatePDF",
    value: function generatePDF(e) {
      if (validateForm(e)) {
        var formData = new FormData(e.target);
  ...
  return HonorariosReportes;
}();

var honorariosReportes = new HonorariosReportes();
...
var Usuario = /*#__PURE__*/function () {
  ...
  _createClass(Usuario, [{
    ...
    key: "closeCreateContractModal",
    value: function closeCreateContractModal() {
    ...
    key: "openEditContract",
    value: function openEditContract() {
      var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      $('#createModal').modal('hide');
      setTimeout(function () {
    ...
    key: "closeDeleteContract",
    value: function closeDeleteContract() {
    ...
    key: "openDeleteContract",
    value: function openDeleteContract(id) {
      $('#createModal').modal('hide');
      setTimeout(function () {
    ...
    key: "changeContractType",
    value: function changeContractType(self) {// const id = $(self).val()
      // if(id == 1) {
    ...
    key: "upsertContract",
    value: function upsertContract(e) {
      e.preventDefault();
      e.stopPropagation();

      if (validateForm(e)) {
        var that = this;
        var id = $('#createContractValue').val();
        var idUser = $('#createValue').val();
        var formData = new FormData(e.target);
    ...
    key: "deleteContract",
    value: function deleteContract() {
      var _this21 = this;

      var id = $('#deleteContractValue').val();
      $.ajax({
        url: '/usuario/contrato/delete/' + id,
        success: function success(_ref26) {
          var deleted = _ref26.deleted;
          $('#deleteContractModal').modal('hide');
          setTimeout(function () {
            $('#createModal').modal('show');
    ...
    key: "loadUserContracts",
    value: function loadUserContracts(idUser) {
      $.ajax({
        url: '/usuario/contratos/' + idUser,
        success: function success(_ref27) {
          var contratos = _ref27.contratos,
              permissions = _ref27.permissions;
          var html = contratos.map(function (item) {
            return "\n                    <tr id=\"usuarioContratoRow".concat(item.id_usuario_contrato, "\">\n                        <td>").concat(item.tipo_contrato, "</td>\n                        <td>").concat(item.fecha_inicio, "</td>\n                        <td>").concat(item.fecha_fin, "</td>\n                        <td style=\"width:75px\">\n                            ").concat(permissions.editar && "\n                                <a href=\"javascript:void(0)\" style=\"padding:5px\" class=\"btn text-primary\" type=\"button\"\n                                    onclick=\"usuario.openEditContract(".concat(item.id_usuario_contrato, ")\">\n                                    <span class=\"glyphicon glyphicon-pencil\"></span>\n                                </a>\n                            "), "\n\n                            ").concat(permissions.eliminar && "\n                                <a href=\"javascript:void(0)\" style=\"padding:5px\" class=\"btn text-danger\" type=\"button\"\n                                    onclick=\"usuario.openDeleteContract(".concat(item.id_usuario_contrato, ")\">\n                                    <span class=\"glyphicon glyphicon-remove\"></span>\n                                </a>\n                            "), "\n                        </td>\n                    </tr>");
          });
