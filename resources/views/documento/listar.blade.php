...
<table id="tipoProcesoTable" class="table table-hover" data-empty="Sin documentos" data-filter-container="#filter-form-container" data-sorting="true" data-filter-active="true">
    <thead>
        <tr class="bg-success">
            <th data-sort-id="id_documento">ID</th>
            <th data-sort-id="nombre_documento">Nombre</th>
            <th>¿obligatorio?</th>
            <th data-sort-id="estado_documento">Estado</th>
    ...
    <tfoot>
        <tr class="footable-paging">
            ...
            <span class="label label-default footable-pagination-registers">
                Mostrando del {{$documentos->firstItem()}} al {{$documentos->lastItem()}} de {{ $documentos->total()}} registros
            </span>
        </tr>
    </tfoot>
    @endif
...
<div class="modal fade validate" tabindex="-1" role="dialog" id="createModal">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="documento.closeCreateModal()" aria-label="Close">
            ...
            <form onsubmit="documento.upsert(event)">
                ...
                <div class="modal-footer center">
                    ...
                    <button type="button" class="btn btn-default" onclick="documento.closeCreateModal()">Cancelar</button>
