...
<table id="tipoProcesoTable" class="table table-hover" data-empty="Sin tipos de proceso" data-filter-container="#filter-form-container" data-sorting="true" data-filter-active="true">
    <thead>
        <tr class="bg-success">
            <th data-sort-id="id_tipo_proceso">ID</th>
            <th data-sort-id="nombre_tipo_proceso">Nombre</th>
            <th data-sort-id="estado_tipo_proceso">Estado</th>
        ...
        <tr class="footable-paging">
            <td colspan="8">
                ...
                <span class="label label-default footable-pagination-registers">
                    Mostrando del {{$tiposProceso->firstItem()}} al {{$tiposProceso->lastItem()}} de {{ $tiposProceso->total()}} registros
                </span>
            </td>
        </tr>
    </tfoot>
