...
<div class="modal fade validate" tabindex="-1" role="dialog" id="createModal">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="usuario.closeCreateModal()" aria-label="Close">
            ...
            <form onsubmit="usuario.upsert(event)" enctype="multipart/form-data">
                ...
                <div class="modal-footer center">
                    ...
                    <button type="button" class="btn btn-default" onclick="usuario.closeCreateModal()">Cancelar</button>
